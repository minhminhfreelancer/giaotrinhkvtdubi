...
const getTheme1ByMonth = (month: number): string => {
  switch (month) {
    ...
    case 2:
      return "Chủ đề: Con cái của lời hứa và dân sót lại";
    case 3:
...
const getTheme3ByMonth = (month: number): string => {
  switch (month) {
    ...
    case 2:
      return "Chủ đề: Tai ương sau cùng và sự phán xét";
    case 3:
...
const getTheme4ByMonth = (month: number): string => {
  switch (month) {
    ...
    case 2:
      return "Chủ đề: Sự Mầu Nhiệm của Lễ Vượt Qua";
    case 3:
    ...
    <div className="bg-white p-4 rounded-xl shadow-sm">
      ...
      <div className="space-y-4">
        <div className="border border-gray-200 rounded-lg p-3">
          <h4 className="font-medium text-gray-900 mb-3">1. Đọc sách</h4>
